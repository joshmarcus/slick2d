 ...
 * @author kevin
 */
public class DoubleEncoder implements FieldEncoder {
	 ...
	 */
	public DoubleEncoder(Field field) {
		this.field = field;
	...
	public void decode(DataInputStream din, Object value) throws IOException {
		try {
			field.setDouble(value, din.readDouble());
	...
	public void encode(DataOutputStream dout, Object value) throws IOException {
		try {
			dout.writeDouble(field.getDouble(value));
		} catch (IllegalArgumentException e) {
