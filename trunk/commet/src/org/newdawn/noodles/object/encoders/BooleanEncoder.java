 ...
 * @author kevin
 */
public class BooleanEncoder implements FieldEncoder {
	 ...
	 */
	public BooleanEncoder(Field field) {
		this.field = field;
	...
	public void decode(DataInputStream din, Object value) throws IOException {
		try {
			field.setBoolean(value, din.readBoolean());
	...
	public void encode(DataOutputStream dout, Object value) throws IOException {
		try {
			dout.writeBoolean(field.getBoolean(value));
		} catch (IllegalArgumentException e) {
