...
public class XMLContext extends StyleContext {
	...
	/** Map<String, Color> */
	protected Map syntaxForegroundMap = null, syntaxBackgroundMap;
	...
	public XMLContext () {
		...
		syntaxBackgroundMap = new HashMap();

		Font defaultFont = new Font("Monospaced", Font.PLAIN, 11);
		...
		font = defaultFont;
		fontForeground = new Color(0, 0, 128);
		syntaxFontMap.put(syntaxName, font);
		syntaxForegroundMap.put(syntaxName, fontForeground);
		...
		font = defaultFont;
		fontForeground = new Color(0, 127, 127);
		syntaxFontMap.put(syntaxName, font);
		syntaxForegroundMap.put(syntaxName, fontForeground);
		...
		syntaxFontMap.put(syntaxName, font);
		syntaxForegroundMap.put(syntaxName, fontForeground);
		syntaxBackgroundMap.put(syntaxName, new Color(240, 240, 240));
	...
	public Color getSyntaxBackground (int ctx) {
		return (Color)syntaxBackgroundMap.get(getSyntaxName(ctx));
	}
